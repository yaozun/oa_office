package com.oa_office.dept.pojo.dto;
	...
	public static Specification<Dept> getSpecification(DeptQueryDTO deptQueryDTO) {
		...
		Specification<Dept> spec = new Specification<Dept>() {
			...
			public Predicate toPredicate(Root<Dept> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if (null != deptQueryDTO && !StringUtils.isEmpty(deptQueryDTO.getDeptName())) {
					Predicate p1 = cb.like(root.get("deptName").as(String.class),
